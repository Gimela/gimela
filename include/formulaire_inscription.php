		...
		<form method="post" action="#" > 
			<div id="form_inscription">
								...
								<p> 
                                    ...
                                    <input id="naissance" name="naissance" type="date" placeholder="sous la forme jj/mm/aaaa" min="1920-01-01" min="2050-01-01"/>
                                </p>
								<p> 
                                    <label for="profession" class="job" data-icon="">Profession</label>
                                    <input id="profession" name="profession" type="text" placeholder="ex. ingénieur en réalité augmenté"/>
                                </p>
								...
								<p> 
                                    ...
                                    <input id="tel_fixe" name="tel_fixe" type="tel" placeholder="0100000000" />
                                </p>
								<p> 
